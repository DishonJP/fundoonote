...
class Search extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            menuanchorEl: null,
            menuOpen: false,
            title: this.props.searchNotes.data().title,
            content: this.props.searchNotes.data().notes,
            cardOpen: false,
            cardanchorEl: null,
            trash: false,
            ...
            label: this.props.searchNotes.data().notelabel,
            remainder: this.props.searchNotes.data().remainder,
            archive: this.props.searchNotes.data().archive,
            remOpen: false,
            remAnchorEl: null,
            labelMenu: false,
            labelAnchorEl: null,
